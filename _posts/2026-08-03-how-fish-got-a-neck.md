---
layout: post
title: "How Fish Got a Neck: The Evolution of the Shoulder Girdle"
date: 2026-08-03 10:00:00
description: How the vertebrate pectoral girdle and neck originated, and why the fossil, neuroanatomical, and embryological evidence points to repatterning at the head–trunk interface rather than a transformed gill arch.
tags: biology evolution palaeontology
categories: vertebrate-evolution
toc:
  beginning: true
---
...
Where this structure came from is still contested after more than a century of work. The classical literature splits between a trunk-based origin from ventrolateral fin folds and a derivation from a posterior branchial (gill) arch. The debate has recently reopened in a sharp form. [Brazeau et al. (2023)](#ref-brazeau) argued from placoderm and osteostracan fossils that the girdle arose by incorporating the sixth branchial arch into the trunk. [Miyashita et al. (2025)](#ref-miyashita) countered that the neurovascular anatomy of jawless stem gnathostomes places the pectoral attachment unambiguously in the trunk domain. [Kuroda et al. (2024)](#ref-kuroda) added zebrafish fate-mapping data pointing the same way.
...
<div class="row justify-content-sm-center">
    <div class="col-sm-7 mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig1.png" title="Gill-arch and fin-fold hypotheses" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 1.</b> Scheme of the gill-arch hypothesis (A) and the fin-fold hypothesis (B). From <a href="#ref-pieretti">Pieretti et al. (2015)</a>.
</div>

The **fin-fold hypothesis**, first articulated in the late nineteenth century ([Balfour 1881](#ref-balfour); [Thacher 1877](#ref-thacher)) and later refined through comparative anatomy, proposes that paired fins evolved from continuous longitudinal folds of tissue running along the ventrolateral margins of the trunk. Early vertebrates on this view possessed extended fin folds that stabilized swimming, analogous to the median fin fold that gives rise to the dorsal and anal fins. Through evolutionary subdivision and regional specialization, these continuous folds were partitioned into discrete pectoral and pelvic fins.

The hypothesis has been regarded as particularly successful because it is broadly consistent with developmental genetic evidence showing shared patterning mechanisms between paired and unpaired fins ([Freitas et al. 2006](#ref-freitas)). Fossil evidence from early jawed vertebrates and their stem relatives supports it further, as several taxa exhibit ventrolateral fin structures that appear intermediate between continuous folds and discrete appendages ([Gai et al. 2022](#ref-gai)).
...
[Brazeau et al. (2023)](#ref-brazeau) proposed a renewed and more explicitly fossil-based version of the archipterygium hypothesis, arguing that the vertebrate pectoral girdle originated through the incorporation of a posterior branchial arch into the trunk during early gnathostome evolution. Their argument rests on a detailed anatomical reinterpretation of placoderm and osteostracan fossils, with particular emphasis on cranial articulation surfaces, vascular topology, and the positional relationship between the branchial skeleton and the shoulder girdle.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig2.png" title="Cranial processes and branchial arch attachments in stem gnathostomes" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 2.</b> Comparative anatomy of cranial processes and branchial arch attachments in stem gnathostomes. <b>a</b>, Osteostracan <i>Nectaspis</i>. <b>b</b>, Acanthothoracid placoderm <i>Kolymaspis</i>. <b>c</b>, Acanthothoracid placoderm <i>Romundina</i>. Transparent blue structures represent reconstructed branchial arches (art.ba1–6). From <a href="#ref-brazeau">Brazeau et al. (2023)</a>.
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig3.jpeg" title="Skull and endocast of Mimetaspis hoeli" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 3.</b> Posterior section of the skull and endocast of the osteostracan <i>Mimetaspis hoeli</i>, showing the position of the subclavian artery relative to the gill compartments. From <a href="#ref-brazeau">Brazeau et al. (2023)</a>.
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-7 mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig4.png" title="Summary phylogeny of early gnathostomes" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 4.</b> Summary phylogeny of early gnathostomes with reconstructions showing comparative anatomy of pharyngeal arches and shoulder linkages. Blue, branchial arches; orange, sixth branchial or thoracic arch; pink, pectoral fin attachment or scapulocoracoid. From <a href="#ref-brazeau">Brazeau et al. (2023)</a>.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig5.jpeg" title="Circulatory system of Norselaspis" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 5.</b> The circulatory system of <i>Norselaspis</i>. From <a href="#ref-miyashita">Miyashita et al. (2025)</a>.
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-7 mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig6.jpeg" title="Pectoral fin attachment of Norselaspis" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 6.</b> The pectoral fin attachment of <i>Norselaspis</i>. From <a href="#ref-miyashita">Miyashita et al. (2025)</a>.
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig7.jpeg" title="Key gnathostome traits in jawless fishes" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 7.</b> Key gnathostome traits evolved early in jawless fishes. From <a href="#ref-miyashita">Miyashita et al. (2025)</a>.
</div>
...
Recent embryological work by [Kuroda et al. (2024)](#ref-kuroda) provides independent and mechanistically robust support for this interpretation. Using high-resolution lineage tracing and genetic fate-mapping in zebrafish, the study addresses a question fossils alone cannot settle: from which embryonic tissues do the individual elements of the pectoral girdle arise?

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/neck_fig8.jpeg" title="Embryonic origins of the zebrafish pectoral girdle" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    <b>Figure 8.</b> Embryonic origins and environment of the zebrafish pectoral girdle. <b>a</b>, Four embryonic populations reside at the prospective pectoral girdle region at the 10–12 somite stage; they establish the embryonic head/trunk interface by the pharyngula stage. <b>b</b>, Schematic of the left pectoral region of a zebrafish larva, colour-coded by embryonic origin: somite-derived, pink; fin-field LPM-derived, yellow; CPM-derived, green; branchial neural crest cell-derived, light blue. From <a href="#ref-kuroda">Kuroda et al. (2024)</a>.
</div>
...
<a name="ref-balfour"></a>
Balfour, F. M. (1881). On the development of the skeleton of the paired fins of Elasmobranchii, considered in relation to its bearings on the nature of the limbs of the Vertebrata. *Proceedings of the Zoological Society of London* **49**(3), 656–670. [DOI](https://doi.org/10.1111/j.1096-3642.1881.tb01323.x)

<a name="ref-brazeau"></a>
Brazeau, M. D., Castiello, M., El Fassi El Fehri, A., Hamilton, L., Ivanov, A. O., Johanson, Z. & Friedman, M. (2023). Fossil evidence for a pharyngeal origin of the vertebrate pectoral girdle. *Nature* **623**(7987), 550–554.

<a name="ref-freitas"></a>
...
<a name="ref-gegenbaur"></a>
Gegenbaur, C. (1876). Zur Morphologie der Gliedmassen der Wirbelthiere. *Morphologisches Jahrbuch* **2**, 396.

<a name="ref-kuroda"></a>
Kuroda, S., Lalonde, R. L., Mansour, T. A., Mosimann, C. & Nakamura, T. (2024). Multiple embryonic sources converge to form the pectoral girdle skeleton in zebrafish. *Nature Communications* **15**(1), 6313.

<a name="ref-miyashita"></a>
Miyashita, T., Janvier, P., Tietjen, K., Berenguer, F., Schöder, S., Marone, F., Gueriau, P. & Coates, M. I. (2025). Novel assembly of a head–trunk interface in the sister group of jawed vertebrates. *Nature* **645**(8081), 686–691.

<a name="ref-pieretti"></a>
Pieretti, J., Gehrke, A. R., Schneider, I., Adachi, N., Nakamura, T. & Shubin, N. H. (2015). Organogenesis in deep time: a problem in genomics, development, and paleontology. *Proceedings of the National Academy of Sciences* **112**(16), 4871–4876. [DOI](https://doi.org/10.1073/pnas.1403665112)

<a name="ref-thacher"></a>
Thacher, J. K. (1877). Median and paired fins, a contribution to the history of vertebrate limbs. *Transactions of the Connecticut Academy of Sciences* **3**, 281.
